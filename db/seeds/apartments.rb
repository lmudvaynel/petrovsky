...
#[этаж, квартира] => [dx, dy, площадь, стоимость, проданы?]
  ...
  [3, 1] => [428, 562-40, 74.2, 200000, true],
  [3, 2] => [951, 562-40, 38.0, 200000, true],
  [3, 4] => [1370, 74-40, 145.6, 684902, false],
  [3, 5] => [1995, 562-40, 97.8, 200000, true],
  [3, 6] => [1688, 875-40, 62.1, 200000, true],
  [3, 7] => [1377, 875-40, 57.7, 200000, true],
  [3, 8] => [1168, 875-40, 38.7, 200000, true],
  [3, 9] => [749, 875-40, 76.5, 200000, true],
  [3, 10] => [329, 875-40, 83.3, 200000, true],
  [3, 13] => [103, 562-40, 98.2, 200000, true],
  ...
  [6, 1] => [506, 365-38, 74.2, 505821, false],
  [6, 2] => [976, 365-38, 77.3, 500000, true],
  [6, 3] => [1354, 365-38, 38.3, 500000, true],
  [6, 4] => [1543, 365-38, 56.8, 388058, false],
  [6, 5] => [1886, 363-38, 140.3, 954040, false],
  [6, 6] => [1567, 643-38, 115.8, 500000, true],
  [6, 7] => [1174, 643-38, 170.3, 1141010, false],
  [6, 8] => [796, 645-38, 148.1, 1007080, false],
  [6, 9] => [415, 643-38, 136.3, 500000, true],
  [6, 10] => [213, 361-38, 148.9, 1012520, false]
}
