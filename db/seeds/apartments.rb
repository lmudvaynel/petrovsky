...
#[этаж, квартира] => [dx, dy, площадь, стоимость, проданы?]
  ...
  [3, 1] => [428, 522, 74.2, 200000, true],
  [3, 2] => [951, 522, 38.0, 200000, true],
  [3, 4] => [1370, 34, 145.6, 684902, false],
  [3, 5] => [1995, 522, 97.8, 200000, true],
  [3, 6] => [1688, 835, 62.1, 200000, true],
  [3, 7] => [1377, 835, 57.7, 200000, true],
  [3, 8] => [1168, 835, 38.7, 200000, true],
  [3, 9] => [749, 835, 76.5, 200000, true],
  [3, 10] => [329, 835, 83.3, 200000, true],
  [3, 13] => [103, 522, 98.2, 200000, true],
  ...
  [6, 1] => [506, 324, 74.2, 505821, false],
  [6, 2] => [976, 324, 77.3, 500000, true],
  [6, 3] => [1354, 324, 38.3, 500000, true],
  [6, 4] => [1543, 324, 56.8, 388058, false],
  [6, 5] => [1886, 324, 140.3, 954040, false],
  [6, 6] => [1567, 605, 115.8, 500000, true],
  [6, 7] => [1174, 605, 170.3, 1141010, false],
  [6, 8] => [796, 607, 148.1, 1007080, false],
  [6, 9] => [415, 605, 136.3, 500000, true],
  [6, 10] => [213, 323, 148.9, 1012520, false]
}
