...
#[этаж, квартира] => [dx, dy, площадь, стоимость, проданы?]
  [1, 1] => [427, 328, 82.0, 430215, true],
  [1, 2] => [951, 328, 38.5, 200000, true],
  [1, 3] => [1370, 328, 67.5, 266185, true],
  [1, 4] => [1580, 328, 146.7, 200000, true],
  [1, 5] => [1998, 328, 312.9, 594994, true],
  [1, 6] => [1690, 641, 111.5, 386200, true],
