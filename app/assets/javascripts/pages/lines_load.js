...
/*
      lines.getByElement('thesis harmony')[0].animations.opacityTo(1, { wordFrom: 0, wordTo: 2 }, callback);
    },
    function () {
*/
      lines.getByElement('thesis harmony')[0].animations.opacityTo(0.5, { wordFrom: 0, wordTo: 2 });
    ...
    function () {
      lines.getByElement('thesis harmony')[0].animations.opacityTo(0, { wordFrom: 3 }, callback);
    },
    ...
    function () {
      ...
      lines.getByElement('thesis liberty')[0].animations.opacityTo(0.5, { wordFrom: 0, wordTo: 2 });
    ...
    function () {
      lines.getByElement('thesis liberty')[0].animations.opacityTo(0, { wordFrom: 3 }, callback);
    },
    ...
    function () {
      ...
      lines.getByElement('thesis comfort')[0].animations.opacityTo(0.5, { wordFrom: 0, wordTo: 2 });
